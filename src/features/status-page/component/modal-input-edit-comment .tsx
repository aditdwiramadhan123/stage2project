...
import useEditComment from "../hook/use-edit-comment ";
import { FaEdit } from "react-icons/fa";

function ModalFormEditComment({
  commentId,
  threadId,
}: {
  commentId: number;
  ...
  const { register, handleSubmit, onSubmit, preview, handleImageChange } =
    useEditComment(commentId, threadId);
    ...
    <>
      ...
      >
        ...
        <ModalContent bg={"brand.tertiary"}>
          <ModalHeader color={"white"}>Edit your comment!</ModalHeader>
          <ModalCloseButton />
...
export default ModalFormEditComment;
